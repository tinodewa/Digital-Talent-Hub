...
<body>
    ...
    <section class="card-section talent-file company-applicant-list">
        <div class="container">
                            ...
                            <div class="col-md-12">
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-3 d-flex justify-content-end align-items-center">
                                        <a href="#" class="btn btn-primary btn-list-apply mb-0 d-flex justify-content-center align-items-center text-decoration-none">
