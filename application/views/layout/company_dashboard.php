                            ...
                            <form>
                                <div class="row no-gutters d-flex justify-content-center">
                                    <div class="form-group col-8 col-md-6">
                                        <input placeholder="What are you loking for?" type="text"
                                            class="form-control input-talent" id="inputTalent"
                                            aria-describedby="inputTalent">
                                    </div>
                                    ...
                                    <a href="<?= site_url('company/project') ?>">
                                        <div class="card w-100 pt-0 pb-0">
                                            <div class="card-body row no-gutters">
                                                <div
                                                    class="col-12 col-sm-6 col-md-3 col-lg-2 order-1 order-md-1 d-flex align-items-center justify-content-center">
                                                ...
                                                <div
                                                    class="col-12 col-sm-6 col-md-6 col-lg-8 order-3 order-md-2 justify-content-center text-center text-sm-left">
                                                ...
                                                <div
                                                    class="col-12 col-sm-6 col-md-3 col-lg-2 order-2 order-md-3 d-flex align-items-center justify-content-center">
