<section class="navbar-section mb-4">
    ...
    <div class="container">
        <nav class="navbar navbar-expand-md navbar-light">
            <a class="navbar-brand order-md-1" href="#"><img src="<?= base_url('assets/img/logo_talenthub.png') ?>" alt="logo digitalent hub"></a>
            <div class="navbar-control-box order-md-3">
                <a class="navbar-notification-box" data-bs-toggle="popover1" data-bs-placement="left" data-bs-content-id="popover-content" tabindex="0" role="button">
                    <div class="navbar-notification"></div>

                </a>
                <a class="navbar-img-box" data-bs-toggle="popover2" data-bs-placement="left" data-bs-content-id="popover-content2" tabindex="0" role="button">
                    <!-- new -->
